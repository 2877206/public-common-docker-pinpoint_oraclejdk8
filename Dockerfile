...
ENV PINPOINTAGENT_VERSION=1.6.2 \
    ...
    PINPOINT_PROFILER_CALLSTACK_MAX_DEPTH=64 \
    ...
    PINPOINT_PROFILER_JDBC_MARIADB=true \
    ...
    PINPOINT_PROFILER_JDBC_JTDS=true \
    ...
    PINPOINT_PROFILER_MEMCACHED=true \
    PINPOINT_PROFILER_MEMCACHED_KEYTRACE=true \
    PINPOINT_PROFILER_THRIFT_CLIENT=true \
    PINPOINT_PROFILER_THRIFT_CLIENT_ASYNC=true \
    PINPOINT_PROFILER_THRIFT_PROCESSOR=true \
    ...
    PINPOINT_PROFILER_ORM_IBATIS=true \
    PINPOINT_PROFILER_ORM_MYBATIS=true \
    ...
    PINPOINT_PROFILER_JSON_GSON=true \
    PINPOINT_PROFILER_JSON_JACKSON=true \
    PINPOINT_PROFILER_JSON_JSONLIB=true \
    ...
    PINPOINT_PROFILER_HYSTRIX=true \
